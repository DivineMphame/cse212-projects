...
public class TakingTurnsQueueTests
{
    ...
    // Run 10 times.
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // Defect(s) Found: The test fails because the turns for Tim are modified to a very big number.The people with infinite turns (turns <= 0)were not re-added to the queue.
    ...
    // Defect(s) Found: None
    // The test passes if the exception is thrown and the message matches.
